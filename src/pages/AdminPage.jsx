...
function compareSourcesByDisplayOrderThenShortTitle(sourceA, sourceB) {
...
function AdminPage() {
  ...
  const questionMatrix = useMemo(() => {
    const activeSources = sources
      ...
      .sort(compareSourcesByDisplayOrderThenShortTitle)
  ...
  async function loadSources() {
    ...
    const sortedRows = [...rows].sort(compareSourcesByDisplayOrderThenShortTitle)
  ...
  async function loadQuestionMatrixQuestions() {
    ...
    try {
      ...
      setQuestionMatrixQuestions(allRows)
    } catch (err) {
      setQuestionMatrixError(
  ...
  "questions": [
    {
      ...
      <details className="admin-section" open>
        ...
        <p className="admin-row-count">
          Counts include active questions only for active book sources.
        </p>
